...
```python
    def set_freqai_targets(self, dataframe, **kwargs) -> DataFrame:
        ...
        *Only functional with FreqAI enabled strategies*
        ...
        https://www.tradescope.io/en/latest/freqai-feature-engineering
...
```python
from tradescope.freqai.prediction_models.ReinforcementLearner import ReinforcementLearner
from tradescope.freqai.RL.Base5ActionRLEnv import Actions, Base5ActionRLEnv, Positions
