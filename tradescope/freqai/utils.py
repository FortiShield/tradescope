...
from tradescope.freqai.data_drawer import FreqaiDataDrawer
...
def get_tb_logger(model_type: str, path: Path, activate: bool) -> Any:
    ...
    if model_type == "pytorch" and activate:
        from tradescope.freqai.tensorboard import TBLogger
        return TBLogger(path, activate)
    else:
        from tradescope.freqai.tensorboard.base_tensorboard import BaseTensorboardLogger
